...
alter table SURVEY_POSSIBLE_ANSWER add constraint FK_SURVEY_POSSIBLE_ANSWER_QUESTION foreign key (QUESTION_ID) references SURVEY_QUESTION(ID)^
...
alter table SURVEY_FILLED_SURVEY add constraint FK_SURVEY_FILLED_SURVEY_SURVEY foreign key (SURVEY_ID) references SURVEY_SURVEY(ID)^
alter table SURVEY_FILLED_SURVEY add constraint FK_SURVEY_FILLED_SURVEY_USER foreign key (USER_ID) references SEC_USER(ID)^
...
alter table SURVEY_SELECTED_ANSWER add constraint FK_SURVEY_SELECTED_ANSWER_QUESTION foreign key (QUESTION_ID) references SURVEY_QUESTION(ID)^
alter table SURVEY_SELECTED_ANSWER add constraint FK_SURVEY_SELECTED_ANSWER_ANSWER foreign key (ANSWER_ID) references SURVEY_POSSIBLE_ANSWER(ID)^
alter table SURVEY_SELECTED_ANSWER add constraint FK_SURVEY_SELECTED_ANSWER_FILLED_SURVEY foreign key (FILLED_SURVEY_ID) references SURVEY_FILLED_SURVEY(ID)^
