...
-- begin SURVEY_ANSWER
alter table SURVEY_ANSWER add constraint FK_SURVEY_ANSWER_QUESTION_ID foreign key (QUESTION_ID) references SURVEY_QUESTION(ID)^
alter table SURVEY_ANSWER add constraint FK_SURVEY_ANSWER_ANSWER_ID foreign key (ANSWER_ID) references SURVEY_POSSIBLE_ANSWER(ID)^
alter table SURVEY_ANSWER add constraint FK_SURVEY_ANSWER_FILLED_SURVEY_ID foreign key (FILLED_SURVEY_ID) references SURVEY_FILLED_SURVEY(ID)^
create index IDX_SURVEY_ANSWER_ANSWER on SURVEY_ANSWER (ANSWER_ID)^
create index IDX_SURVEY_ANSWER_QUESTION on SURVEY_ANSWER (QUESTION_ID)^
create index IDX_SURVEY_ANSWER_FILLED_SURVEY on SURVEY_ANSWER (FILLED_SURVEY_ID)^
-- end SURVEY_ANSWER
